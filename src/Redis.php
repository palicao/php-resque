 ...
 * @method boolean sismember(string $key, string $member)
 * @method void sadd(string $key, string $value)
 * @method void set(string $key, string $value)
 * @method void srem(string $key, string $value)
 * @method int del(string $key)
 * @method string get(string $key)
 * @method int rpush(string $key, string $value)
 * @method int incrby(string $key, int $by)
 * @method int decrby(string $key, int $by)
 * @method string lpop(string $key)
 * @method string blpop(string $key, int $timeout)
 * @method void expire(string $key, int $expire)
 * @method boolean exists(string $key)
 */
class Redis
{
	/**
